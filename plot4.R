...
# Create a PNG file of 4 different graphs
...
with(dt,
     {plot(Date_time, Global_active_power, type = "l",
      ...
      plot(Date_time, Sub_metering_1, type = "l", col = "green",
           xlab = "", ylab = "Energy Sub Metering")
      legend("topright", pch = "--", col = c("green", "blue", "black"),
             legend = c("Sub metering 1", "Sub metering 2", "Sub metering 3"))
      lines(Date_time, Sub_metering_2, col = "blue")
      lines(Date_time, Sub_metering_3, col = "black")
      plot(Date_time, Global_reactive_power, type = "l", xlab = "Date-time",
